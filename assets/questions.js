const questions = [
  ...
  },
  {
    numero: 2,
    question:
      "Who are the four beginner characters that you start the game with?",
    answer: [
  ...
  },
  {
    numero: 6,
    question:
      "Which island of Inazuma is known for its Aztec-like story theme?",
  ...
  },
  {
    numero: 8,
    question:
      "How many Fatui Harbingers were there originally (We don't talk about Signora)?",
    answer: ["11", "9", "6"],
    rightAnswer: "11",
  },
  {
    numero: 9,
    question:
      "Who was it who originally sealed away the traveler and their twin?",
    answer: [
      "Kiana Kaslana",
  ...
  },
  {
    numero: 10,
    question:
      "What are the virtues of the currently encountered archons of Teyvat (as of 3.0)?",
    answer: [
  ...
  },
  {
    numero: 16,
    question:
      "Before the First Who Came, who, or what, were the original inhabitants of Teyvat?",
  ...
  },
  {
    numero: 17,
    question:
      "What is the name of Albedo's brother, also created by Rhinedottir?",
